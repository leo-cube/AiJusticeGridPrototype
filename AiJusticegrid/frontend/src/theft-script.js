...
const API_ENDPOINT = `${API_BASE_URL}/api/theft`;
        ...
        chatMessages.innerHTML = `
            <div class="welcome-message">
                ...
                <div class="welcome-content">
                    <h2>Theft Agent</h2>
                    <p>I'm your AI assistant specialized in theft investigations. I'll help you analyze theft cases, track stolen property, and provide comprehensive investigative support.</p>
...
async function downloadPDF() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/theft/download-pdf`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (response.ok) {
            ...
            a.href = url;
            a.download = `TheftAgent_Investigation_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
