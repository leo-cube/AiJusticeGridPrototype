...
const API_ENDPOINT = `${API_BASE_URL}/api/onlinefraud`;
        ...
        chatMessages.innerHTML = `
            <div class="welcome-message">
                ...
                <div class="welcome-content">
                    <h2>Online Fraud Agent</h2>
                    <p>I'm your AI assistant specialized in online fraud investigations. I'll help you analyze digital fraud cases, track cybercriminals, and provide comprehensive investigative support.</p>
...
async function downloadPDF() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/onlinefraud/download-pdf`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (response.ok) {
            ...
            a.href = url;
            a.download = `OnlineFraudAgent_Investigation_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
