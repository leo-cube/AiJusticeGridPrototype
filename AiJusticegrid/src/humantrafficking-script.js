...
const API_ENDPOINT = `${API_BASE_URL}/api/humantrafficking`;
        ...
        chatMessages.innerHTML = `
            <div class="welcome-message">
                ...
                <div class="welcome-content">
                    <h2>Human Trafficking Investigation Agent</h2>
                    <p>I'm your AI assistant specialized in human trafficking investigations. I'll help you analyze cases, identify patterns, and provide comprehensive investigative support.</p>
...
async function downloadPDF() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/humantrafficking/download-pdf`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (response.ok) {
            ...
            a.href = url;
            a.download = `HumanTrafficking_Investigation_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
