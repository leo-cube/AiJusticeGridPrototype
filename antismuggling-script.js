...
const API_ENDPOINT = `${API_BASE_URL}/api/antismuggle`;
        ...
        chatMessages.innerHTML = `
            <div class="welcome-message">
                <div class="agent-avatar">
                    <i class="fas fa-antismuggle-check-alt"></i>
                </div>
                <div class="welcome-content">
                    <h2>antismuggle Laundering Agent</h2>
                    <p>I'm your AI assistant specialized in anti smuggling investigations. I'll help you analyze financial crimes, track suspicious transactions, and provide comprehensive investigative support.</p>
...
async function downloadPDF() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/antismuggle/download-pdf`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (response.ok) {
            ...
            a.href = url;
            a.download = `AntiSmuggling_Investigation_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
