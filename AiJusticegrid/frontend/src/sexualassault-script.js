...
const API_ENDPOINT = `${API_BASE_URL}/api/sexualassault`;
        ...
        chatMessages.innerHTML = `
            <div class="welcome-message">
                ...
                <div class="welcome-content">
                    <h2>Sexual Assault Agent</h2>
                    <p>I'm your AI assistant specialized in sexual assault investigations. I'll help you analyze cases with sensitivity, support victims, and provide comprehensive investigative guidance.</p>
...
async function downloadPDF() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/sexualassault/download-pdf`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (response.ok) {
            ...
            a.href = url;
            a.download = `SexualAssaultAgent_Investigation_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
