...
const API_ENDPOINT = `${API_BASE_URL}/api/moneylaundering`;
        ...
        chatMessages.innerHTML = `
            <div class="welcome-message">
                ...
                <div class="welcome-content">
                    <h2>Money Laundering Agent</h2>
                    <p>I'm your AI assistant specialized in money laundering investigations. I'll help you analyze financial crimes, track suspicious transactions, and provide comprehensive investigative support.</p>
...
async function downloadPDF() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/moneylaundering/download-pdf`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (response.ok) {
            ...
            a.href = url;
            a.download = `MoneyLaunderingAgent_Investigation_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
