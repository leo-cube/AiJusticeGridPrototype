...
const API_ENDPOINT = `${API_BASE_URL}/api/surveillance`;
        ...
        chatMessages.innerHTML = `
            <div class="welcome-message">
                ...
                <div class="welcome-content">
                    <h2>Surveillance Agent</h2>
                    <p>I'm your AI assistant specialized in surveillance operations. I'll help you plan monitoring activities, analyze surveillance data, and provide comprehensive operational support.</p>
...
async function downloadPDF() {
    ...
    try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/surveillance/download-pdf`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (response.ok) {
            ...
            a.href = url;
            a.download = `SurveillanceAgent_Investigation_Report_${new Date().toISOString().slice(0, 10)}.pdf`;
